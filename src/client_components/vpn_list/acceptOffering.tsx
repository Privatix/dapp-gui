                    ...
                    <div className='form-group row'>
                        ...
                        <div className='col-9'>
                            <div className='input-group bootstrap-touchspin'>
                                <input type='text' className='form-control' value={floatTo8FixedShow({number: (offering.unitPrice / 1e8)})} readOnly/>
                    ...
                    <div className='card m-b-20'>
                        ...
                        <div className='card-body'>
                            ...
                            <div className='form-group row'>
                                ...
                                <div className='col-6'>
                                    <div className='input-group bootstrap-touchspin'>
                                        <input id='offeringDeposit' type='text' className='form-control' value={floatTo8FixedShow({number: (this.state.deposit / 1e8)})} readOnly/>
                                        <span className='input-group-addon bootstrap-touchspin-postfix'>PRIX</span>
                                    </div>
                                    <span className='help-block'>
                            ...
                            <div className='form-group row'>
                                ...
                                <div className='col-6 col-form-label font-18'>
                                    <strong>{floatTo8FixedShow({number: (this.state.deposit / 1e8)})} PRIX</strong>
                                </div>
                            </div>
                        </div>
                    </div>
