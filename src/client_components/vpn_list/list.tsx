                                ...
                                <div className='form-group row'>
                                    <div className='col-6'>
                                        <div className='input-group'>
                                            ...
                                            <input type='text' className='form-control' placeholder='0' id='priceFrom' value={this.state.from}/>
                                        </div>
                                    </div>
                                    <div className='col-6'>
                                        <div className='input-group'>
                                            ...
                                            <input type='text' className='form-control' placeholder='1' id='priceTo' value={this.state.to}/>
                                        </div>
                                    </div>
                                </div>
...
// export default asyncReactor(AsyncList, Loader);
