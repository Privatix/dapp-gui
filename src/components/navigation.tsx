                ...
                <div id='sidebar-menu'>
                    <ul>
                        ...
                        <li className='has_sub'>
                            <NavLink to='/products' activeClassName='active' className='waves-effect'><i className='md md-list'></i> <span> Services </span> <span className='menu-arrow'></span></NavLink>
                            <ul className='list-unstyled'>
                                <li><NavLink exact to='/products' activeClassName='active' className='waves-effect'>Active</NavLink></li>
                                <li><NavLink exact to='/products/archive' activeClassName='active' className='waves-effect'>Archive</NavLink></li>
                        ...
                        <li className=''>
                            <NavLink exact to='/auth' activeClassName='active' className='waves-effect'><i className='dripicons-blog'></i><span> Auth </span></NavLink>
                        </li>
                    </ul>
